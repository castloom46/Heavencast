...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden -mt-24 pt-32 pb-20 md:pb-28 bg-hero">
      ...
      {/* Tinted Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-background/90 via-background/80 to-background/90 z-10" />

      {/* Background ambience */}
      <div className="absolute inset-0 grid-bg opacity-25 z-20" />
      <div className="absolute -top-40 left-1/3 h-[28rem] w-[28rem] rounded-full bg-neon-purple/30 blur-3xl animate-glow z-20" />
      <div className="absolute top-40 -right-40 h-[32rem] w-[32rem] rounded-full bg-neon-pink/25 blur-3xl animate-glow z-20" />
      <div className="absolute -bottom-20 -left-20 h-72 w-72 rounded-full bg-neon-blue/25 blur-3xl animate-glow z-20" />
