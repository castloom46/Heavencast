...
export const Route = createFileRoute("/legal/terms")({
  head: () => ({ meta: [{ title: "Terms & Conditions — HeavenCast" }, { name: "description", content: "The terms governing your use of HeavenCast products and services." }] }),
  component: () => (
    <LegalLayout
      title="Terms & Conditions"
      updated="May 2026"
      sections={[
        { id: "agreement", heading: "Agreement", body: <p>By using HeavenCast products and services you agree to these Terms. If you don't agree, please don't use the services.</p> },
        ...
        { id: "ip", heading: "Intellectual property", body: <p>All software, designs and content are owned by HeavenCast or its licensors and are protected by law.</p> },
