...
export const Route = createFileRoute("/legal/disclaimer")({
  head: () => ({ meta: [{ title: "Disclaimer. HeavenCast" }, { name: "description", content: "Disclaimer for HeavenCast content, services and third party apps." }] }),
  component: () => (
    <LegalLayout
      title="Disclaimer"
      updated="May 2026"
      sections={[
        ...
        { id: "third-party", heading: "Third party content", body: <p>HeavenCast devices may surface content from third party providers. We are not responsible for that content, its availability, or any subscription terms set by those providers.</p> },
