  ...
  component: () => (
    <LegalLayout
      ...
      sections={[
        ...
        { id: "data", heading: "Data we collect", body: <p>Account details (name, email), device identifiers, viewing activity within HeavenCast apps, and diagnostic logs needed to operate our services.</p> },
